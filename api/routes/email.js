            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px; margin: 32px auto; background: #fff; border-radius: 16px; box-shadow: 0 4px 24px rgba(26,115,232,0.07); border: 1px solid #e0e6ed; overflow: hidden;">
              <tr>
                <td style="background: #1a73e8; padding: 32px 0; text-align: center;">
                  <img src="https://chefu-academy.com/logo.png" alt="CheFu Academy Logo" width="80" style="border-radius: 50%; box-shadow: 0 2px 8px rgba(0,0,0,0.08); margin-bottom: 8px;" />
              ...
              <tr>
                <td style="padding: 32px 32px 16px 32px; color: #222;">
                  ...
                  <div style="text-align: center; margin: 32px 0;">
                    <a href="chefuacademy://home" style="background: linear-gradient(90deg,#1a73e8,#4285f4); color: #fff; padding: 16px 36px; border-radius: 8px; font-size: 1.1rem; font-weight: 600; text-decoration: none; box-shadow: 0 2px 8px rgba(26,115,232,0.10); display: inline-block; letter-spacing: 0.5px;">
                      🚀 Start Learning
                    </a>
                  </div>
                  <p style="font-size: 1.05rem; line-height: 1.7; margin: 0 0 18px 0;">
              ...
              <tr>
                <td style="padding: 0 32px 32px 32px; color: #888; font-size: 0.98rem;">
                  ...
                  <p style="margin: 0;">Welcome again, and happy learning!<br />— The CheFu Academy Team</p>
