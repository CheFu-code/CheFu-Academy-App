    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.paragraph}>
          ...
          collect, use, and protect your information when using our app.
        </Text>

        <Text style={styles.subtitle}>1. Information We Collect</Text>
        <Text style={styles.paragraph}>
          We may collect personal details like your name, email address, and
          usage activity to enhance your experience.
        </Text>

        <Text style={styles.subtitle}>2. How We Use Information</Text>
        <Text style={styles.paragraph}>
          We use your data to provide course recommendations, track progress,
          and improve the app’s performance.
        </Text>

        <Text style={styles.subtitle}>3. Data Security</Text>
        <Text style={styles.paragraph}>
          We implement strict security measures to ensure your data is safe and
          not shared with third parties without your consent.
        </Text>

        <Text style={styles.subtitle}>4. Your Control</Text>
        <Text style={styles.paragraph}>
          You can request to delete your account or modify your information at
