...
export default function TermsOfService() {
  ...
  useEffect(() => {
    ...
    AccessibilityInfo.announceForAccessibility("Terms of Service screen loaded");
  }, []);
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <Text style={styles.subtitle} accessibilityRole="header">1. Use of the App</Text>
        <Text style={styles.paragraph}>
          You agree to use the app only for lawful purposes and in a way that
          does not infringe the rights of others.
        </Text>

        <Text style={styles.subtitle} accessibilityRole="header">2. Accounts</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.subtitle} accessibilityRole="header">3. Termination</Text>
        <Text style={styles.paragraph}>
          We reserve the right to suspend or terminate your access if you
          violate these terms or misuse the app.
        </Text>

        <Text style={styles.subtitle} accessibilityRole="header">4. Changes to Terms</Text>
        <Text style={styles.paragraph}>
          We may update these terms at any time. Continued use of the app after
          changes means you accept the new terms.
        </Text>

        <Text style={styles.subtitle} accessibilityRole="header">5. Contact Us</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.footer}>
          Last updated: {LAST_UPDATED.toLocaleDateString(undefined, { year: 'numeric', month: 'long', day: 'numeric' })}
        </Text>
      </ScrollView>
    </View>
  );
