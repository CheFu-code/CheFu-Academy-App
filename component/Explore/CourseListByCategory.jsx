  ...
  if (loading && courseList.length === 0) {
    return (
      <View style={{ alignItems: "center", padding: 20 }}>
        ...
        />
        <Text style={{ marginTop: 10, fontFamily: "outfit-bold", fontSize: 16, color: Colors.PRIMARY }}>
          Exploring more courses...
        </Text>
        <Text style={{ fontFamily: "outfit", color: "#ccc", marginTop: 10, textAlign: "center" }}>
          This might take some time to load all the courses, please be patient and monitor your network connection!
        </Text>
      </View>
    );
  }
